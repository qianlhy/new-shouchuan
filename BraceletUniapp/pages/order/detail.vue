...
.status-chip.s0 { background: #F3EEFF; color: #ffb300; } /* 待支付 - 黄色 */
...
.logistics-btn {
  ...
  gap: 8rpx;
  padding: 16rpx 32rpx;
  background: linear-gradient(135deg, #6B4EFF 0%, #f5a623 100%);
  border-radius: 32rpx;
  margin-top: 8rpx;
}
.logistics-icon {
...
.pay-btn { background: linear-gradient(135deg, #8B6CFF, #6B4EFF); color: #fff; font-weight: 600; }
